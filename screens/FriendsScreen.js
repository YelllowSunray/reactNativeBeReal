...
export default function FriendsScreen({ navigation }) {
  ...
  const renderFriendItem = ({ item }) => (
    <View style={styles.listItem}>
      ...
      <View style={styles.itemInfo}>
        <Text style={styles.itemName}>{formatPhoneDisplay(item.phoneNumber)}</Text>
        <Text style={styles.itemSubtext}>Friend</Text>
      </View>
      <TouchableOpacity
        style={styles.dangerButton}
        onPress={() => handleRemoveFriend(item.id, item.phoneNumber)}
      >
  ...
  const renderReceivedRequestItem = ({ item }) => (
    <View style={styles.listItem}>
      ...
      <View style={styles.itemInfo}>
        <Text style={styles.itemName}>{formatPhoneDisplay(item.user.phoneNumber)}</Text>
